...
public class ExcelToJson{
	...
	static void excelToJson()
	{
        ...
        string dataFolderPath = Application.dataPath + "/Document/Language";
 ...
 static string readExcelData(string fileName)
    {
        ...
        if (fileLineContent != null)
        {
            ...
            //}
            //code.Append("}\n\t");
            //string CSharpFilePath = Application.dataPath + "/Scripts/Script_Data/Script_Doc_CD";
            ...
            //string docPath = "\"Json/Language/" + class_name + "\"";
            ////添加常见且必须的引用字符串
            ...
            //code_Dic.Append("}\n");
            //string DicFilePath = Application.dataPath + "/Scripts/Script_Data/Script_Doc_SD";
