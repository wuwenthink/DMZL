namespace UIWidgets
{
		...
		where TComponent : TreeGraphComponent<TItem>
	{
		...
		public virtual bool SetStyle(Style style)
		{
			...
			if (Used != null)
			{
				Used.ForEach(x => x.SetStyle(style.Collections.DefaultItemBackground, style.Collections.DefaultItemText, style));
			}

			if (Cache != null)
			{
				Cache.ForEach(x => x.SetStyle(style.Collections.DefaultItemBackground, style.Collections.DefaultItemText, style));
			}
