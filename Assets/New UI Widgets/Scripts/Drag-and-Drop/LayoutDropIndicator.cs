namespace UIWidgets
{
	...
	/// </summary>
	[AddComponentMenu("UI/New UI Widgets/Layout Drop Indicator")]
	public class LayoutDropIndicator : MonoBehaviour, IStylable
	{
		...
		public virtual bool SetStyle(Style style)
		{
			...
			if (image != null)
			{
				image.color = style.Collections.DefaultColor;
			}
